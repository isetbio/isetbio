...
%
% Notes:
%    [Note: JNM - scComputeSCIELAB does not exist!]

% History:
%    xx/xx/09       Copyright ImagEval Consultants, LLC.
%    11/01/17  jnm  Comments & formatting

% Example:
%{
   % I don't think this example works, I will try creating another...
   params = scParams;
   vSNR = xyz2vSNR(roiXYZ, whitePtXYZ, params)
%}
%{
...
% imagesc(m1);
% figure(1); 
% subplot(3, 1, 1), hist(m1(:), 30)
% subplot(3, 1, 2); hist(m2(:), 30)
