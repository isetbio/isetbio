function [activationImage, activationImageLMScone, ...
    ...
    computeActivationDensityMap(obj, activation)
...
%
% Notes:
%	 * [Note: XXX - The variable names could be improved (xxxx).?]
%    * [Note: XXX - Good start.  Other (...?)]
%    * TODO: Someone rethink egregiously slow algorithm? (See below)
%
...
%    02/16/18  jnm  Formatting
    ...
    interpolationF = 2;
    dx = dx / interpolationF;
    sampledHexMosaicXaxis = ...
        sampledHexMosaicXaxis(1):dx:sampledHexMosaicXaxis(end);
    sampledHexMosaicYaxis = ...
        sampledHexMosaicYaxis(1):dx:sampledHexMosaicYaxis(end);
