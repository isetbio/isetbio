classdef cMosaic < handle
    ...
    methods (Static)
        ...
        % Function to compute pCurrent response from a cone excitation
        % response using the full biophysical outer-segment model
        [photocurrentDifferentialResponse, photocurrentResponseTimeAxis, photocurrentResponseTransient, theConeOSbiophysModel] = ...
            photocurrentFromConeExcitationRateUsingBiophysicalOSmodel(theConeRadialEccentricityDegs, ...
