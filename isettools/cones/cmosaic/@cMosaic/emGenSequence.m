function params = emGenSequence(obj, durationSeconds, varargin)
% Generate sequence of fixational eye movements for a cMosaic
%
% Syntax
%   params = cm.emGenSequence(varargin)
%
% Inputs
%  durationSeconds
%
% Key/val pairs
%  Working on a help command for this.
%  It does not yet have the ieParamFormat()
%  nTrials is 1 by default.
%
% Output
%   params - When executed, the p.Results params are returned
%
% See also
%   cMosaic.fixEMobj.computeForCmosaic, rng
%
