...
%
% Syntax:
%   [excitationsNoNoise, excitationsNoisy, ...
%    photoCurrents, photoCurrentInstances, responseTemporalSupport] = compute(obj, oi);
%
% Description:
...
%
%    photoCurrents           -  NYI
%    photoCurrentInstances   -  NYI
%    responseTemporalSupport -  NYI
%
