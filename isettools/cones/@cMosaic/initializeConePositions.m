...
%
% @NC - please write comments about this function and its relationship
% to the retinlattice code
%

% Get a little larger region and crop after we compute the cone spacing below
