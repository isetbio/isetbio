...
% cMosaic method for specifying cone aperture
% 
% Synopsis
%   cMosaic.computeConeApertures;
%
% Description of what goes into computing the cone apertures to go here
%
% @NC
%
% See Also
...
% Do we have to recompute because there has been a change?

% If we do not have the cached fields, then yes.
if (isempty(obj.cachedConePartition)) || ...
    ...
    % We have cached fields.
    % Check properties that may affect the partitioning of cone
    % apertures into zones.  Code could be clearer here, or a
    % comment could help. @NC.
    isValid = (...
        (size(obj.coneRFpositionsMicrons,1) == obj.cachedConePartition.nConesNum) && ...
        (isempty(RecursivelyCompareStructs(...
