...
if (rounded.oiRefreshInterval >= rounded.defaultIntegrationTime)
    ...
    for oiIndex = 1:oiSequence.length
        ...
        % Find eye movement indices within the oi limits
         indices = find( ...
        ...
        for iTrialBlock = 1:numel(blockedTrialIndices)
            ...
            integrationTimeForSecondPartialAbsorption = ...
                rounded.eyeMovementTimeAxis(idx) + ...
                rounded.defaultIntegrationTime - tFrameStart; %integration time -p1
            ...
            if (oiIndex > 1) && ...
                ...
                %get only part of the em path and pass it as the fixEMobj
                %to the copied version and then use that one for compute
                %in the next step
                %                                                                                                                                                                                                                                                                                         
