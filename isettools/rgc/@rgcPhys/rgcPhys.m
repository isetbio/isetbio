classdef rgcPhys < rgc 
% @rgcPhys: a subclass of @rgc. This subclass implements retinal
...
% 
%       rgc = rgcPhys(scene, sensor, outersegment, varargin)
% 
...
% 9/2015 JRG
    ...
    methods
        ...
        % Constructor
        function obj = rgcPhys(scene, sensor, outersegment, varargin)
