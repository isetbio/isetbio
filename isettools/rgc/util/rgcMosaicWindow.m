function varargout = rgcMosaicWindow(varargin)
% RGCMOSAICWINDOW MATLAB code for rgcMosaicWindow.fig
%      RGCMOSAICWINDOW, by itself, creates a new RGCMOSAICWINDOW or raises the existing
%      singleton*.
%
%      H = RGCMOSAICWINDOW returns the handle to a new RGCMOSAICWINDOW or the handle to
%      the existing singleton*.
%
%      RGCMOSAICWINDOW('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RGCMOSAICWINDOW.M with the given input arguments.
%
%      RGCMOSAICWINDOW('Property','Value',...) creates a new RGCMOSAICWINDOW or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before rgcMosaicWindow_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to rgcMosaicWindow_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help rgcMosaicWindow

% Last Modified by GUIDE v2.5 16-Jun-2017 14:01:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @rgcMosaicWindow_OpeningFcn, ...
                   'gui_OutputFcn',  @rgcMosaicWindow_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before rgcMosaicWindow is made visible.
function rgcMosaicWindow_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to rgcMosaicWindow (see VARARGIN)
...
% UIWAIT makes rgcMosaicWindow wait for user response (see UIRESUME)
% uiwait(handles.rgcMosaicWindow);
...
function varargout = rgcMosaicWindow_OutputFcn(hObject, eventdata, handles) 
