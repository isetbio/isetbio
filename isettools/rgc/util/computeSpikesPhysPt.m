function spikeTimes = computeSpikesPhysPt(obj, varargin)
...
%                         Vmem(iiPostSpk,:) = Vmem(iiPostSpk,:)+permute(ihhi(:,icell,1:mxi-ispk),[3 1 2]);
                        ...
                        Vmem(iiPostSpk,:) = ((Vmem(iiPostSpk,:)).*exp(permute(ihhi(icell,:,1:mxi-ispk),[3 2 1])));
