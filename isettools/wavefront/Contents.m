...
%
% PSF MANIPULATION AND ANALYSIS (subdir psf). Perform operations on psfs.
% Not directly tied to the wvf structure.
...
%   stilescrawford/sceCreate -                Create Stiles-Crawford structure with various options as to data.
%   stilescrawford/sceGet -                   Get info from Stiles-Crawford structure.
%
...
%   data/autrusseauFigure11.tif -             TIFF image of Figure 11 from Autrusseau et al., used to digitize autrusseauFigure11.txt
%   data/autrusseauFigure11.txt -             Digitized data from Figure 11 of Autrusseau et al. Tab delimited text with column headers.
%   data/autrusseauStandardObserver.txt -     Zernike coefficient data for the "standard observer" of Autrusseau, Thibos, & Shevell (2011),
...
%   data/berendschotEtAl2001_Figure2.jpg      JPEG image of Figure 2 from Berendschot et al., JOSA A, 2001 used to digitize the corresponding text files.
%   data/berendschotEtAl2001_Figure2BoldSmooth.txt
%                                             The smooth bold curve from Figure 2. This is the SCE rho model with choroidal backscatter.
%   data/berendschotEtAl2001_Figure2BoldData.txt   
%                                             The mean SCE rho psychophysical data. 
%   data/berendschotEtAl2001_Figure2BoldSmooth.txt
%                                             The smooth thin curve from Figure 2. This is the SCE rho model without choroidal backscatter.
%   data/sampleZernikeCoeffs.txt -            Zernike coefficient data for 9 subjects in OSA format, measured by Heidi Hofer.
...
%   data/ver121data -                         Directory .mat files output by an early version of the toolbox. Used to validate
...
%   iset/wvf2oi                               Convert wavefront data to ISET optical image with optics
%   iset/wvf2PSF                              Convert a wvf structure to ISET shift-invariant PSF data
%
% DOCS (subdir docs). Various documentation. Mainly PDF of relevant papers.
%
% TOP LEVEL.
%   wvfRootPath                        - Return the path to the root wavefront optics toolbox directory
