...
% as an apodization filter (a spatially-varying amplitude attenuation) to
% the pupil function. In this case, it is a decaying exponential.
%
% Computational Note:
%  If the function is already computed and not stale, this will return fast.
