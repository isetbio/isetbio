...
%
% Description:
%    This function initializes the data structures for a basic ISET
%    session. The isetSession file is saved after initialization.
%
% Inputs:
%    None.
%
...
% Show waitbars/not. Make sure the waitbar preference is set. The others
