...
%    02/28/26  NPC  Rewrote it for isetbio/isetcam.
    ...
    [coneLocationsMicrons, coneApertureDiametersMicrons, outerSegmentLengthMicrons, ...
        coneTypes, micronsPerDegree] = ...
        generateComponents(p.Results.sizeDegs,  p.Results.relativeSconeDensity);

    % Adjust the OS length
    [~, osLengthMicronsFovealHuman] = ...
        cMosaic.outerSegmentLengthFromEccentricity(0);
    osAttenuationFactorsToMatch10MicronLength = ...
        ones(1, numel(coneTypes)) * outerSegmentLengthMicrons/osLengthMicronsFovealHuman;
    ...
    theConeDataStruct = struct(...
        ...
        'outerSegmentLengthAttenationFactors', osAttenuationFactorsToMatch10MicronLength ...
        );
...
function [coneLocationsMicrons, coneApertureDiametersMicrons, outerSegmentLengthMicrons, coneTypes, micronsPerDegree] = ...
    ...
    outerSegmentLengthMicrons = defaultParams.outerSegmentLengthMicrons;
end
