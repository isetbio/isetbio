...
% VISUALIZEOPTICS Visualizes the optical properties at a specified target wavelength.
%
% Syntax:
%   visualizeOptics(theOI, targetWavelength, ...
%   spatialSupportArcMin, spatialFrequencySupportCyclePerDeg, varargin)
%
% Description:
...
%
% Example:
%   visualizeOptics(opticalImage, 550, 30, 10, 'extraOTFData', someData);
%
