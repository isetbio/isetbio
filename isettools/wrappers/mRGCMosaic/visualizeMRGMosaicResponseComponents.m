function figHandlesAndFileNames = visualizeMRGMosaicResponseComponents(theMRGCMosaic, visualizedMRGCindices, noiseFreeResponse, ...
    noisyResponseInstancesConeNoiseOnly, noisyResponseInstancesIntrinsicMRGCnoiseOnly)
    ...
    figHandlesAndFileNames = {};
    figHandlesAndFileNames{numel(figHandlesAndFileNames)+1} = struct(...
        'hFig', hFigNoiseFreeActivation, ...
        'pdfFileName', 'noiseFreeMRGCactivation.pdf');

    figHandlesAndFileNames{numel(figHandlesAndFileNames)+1} = struct(...
        'hFig', hFigSelectResponses, ...
        'pdfFileName', sprintf('coneNoiseOnly_membraneSigma_%2.2f.pdf', theMRGCMosaic.vMembraneGaussianNoiseSigma));


    %% Plot intrinsic noise - only responses of visualized mRGCs
    [~, hFigSelectResponses2] = visualizeResponsesOfSelectMRGCs(5, theMRGCMosaic, visualizedMRGCindices, ...
     ...
     figHandlesAndFileNames{numel(figHandlesAndFileNames)+1} = struct(...
        'hFig', hFigSelectResponses2, ...
        'pdfFileName', sprintf('intrinsicMRGCNoiseOnly_membraneSigma_%2.2f.pdf', theMRGCMosaic.vMembraneGaussianNoiseSigma));
