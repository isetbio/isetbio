...
%                 cooperativity) falls within the range of 1.7-3.2.[Weiss, 1997]
...
%                 modeled by Michaelis–Menten kinetics,[Alon, 2007] in which
...
%
%    Weiss, J. N. (1 September 1997). "The Hill equation revisited: uses and misuses". The FASEB Journal. 11 (11): 835?841.
%
%    Alon, Uri (2007). An Introduction to Systems Biology: Design Principles of Biological Circuits ([Nachdr.] ed.). Boca Raton, FL: Chapman & Hall.
