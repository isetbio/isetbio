...
% 
% Inputs:
%    N     - N-Vector of samples to pull frequencies from
%
% Outputs:
%    fList - Frequency List
%
% Notes:
%    * [Note: XXX - N.B. This routine had a bug for a long time. Sorry. The
%      DC location was improperly placed. Fixed 2005.12.27, I hope.]
