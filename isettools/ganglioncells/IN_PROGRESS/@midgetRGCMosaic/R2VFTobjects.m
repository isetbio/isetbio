function R2VFTobjects(...
    ...
    for iRTVobjIndex = 1:RTVTobjectsNum
        ...
        if (isfield(fitParams, 'initialGridRetinalConePoolingParamsStruct')) && ...
           (~isempty(fitParams.initialGridRetinalConePoolingParamsStruct))
            % See if a previous initial retinal cone pooling params exists
            theDictionaryKeys = keys(fitParams.initialGridRetinalConePoolingParamsStruct.dictionary);
            ...
            if (ismember(theTargetKey, theDictionaryKeys))
                initialRetinalConePoolingParamsStruct = fitParams.initialGridRetinalConePoolingParamsStruct.dictionary(theTargetKey);
