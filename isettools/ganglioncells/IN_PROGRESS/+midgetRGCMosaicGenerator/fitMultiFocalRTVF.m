function fitMultiFocalRTVF(mosaicCenterParams, rfModelParams, opticsParams, stfComputeMethod, varargin)
    ...
    fixedZernikeCoefficientsPositionDegs = p.Results.fixedZernikeCoefficientsPositionDegs;
    ...
    theMultifocalRTVFOBJ = RTVFmultifocal(theMidgetRGCmosaic, ...
        ...
        samplingScheme, stfComputeMethod, ...
        'fixedZernikeCoefficientsPositionDegs', fixedZernikeCoefficientsPositionDegs, ...
