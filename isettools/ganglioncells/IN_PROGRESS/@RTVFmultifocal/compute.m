function compute(obj, ...
    ...
    for iMultifocalRTVFobjIndex = 1:multifocalRTVFobjectsNum
        ...
        [~,~,theTargetVisualRFDoGparams.targetRGCmajorityConeType] = obj.centerConeTypeWeights(theTargetRGCindex);
        ...
        if (strcmp(obj.stfComputeMethod, RTVF.directSTFcomputeMethod))
            % Other cone type
            theTargetRGCindex = obj.targetRGCindexOfDifferentMajorityConeType(iMultifocalRTVFobjIndex);
            indicesOfConesPooledByTheRFcenter = find(obj.theRGCMosaic.rgcRFcenterConeConnectivityMatrix(:,theTargetRGCindex)> 0);
            weightsOfConesPooledByTheRFcenter = reshape(...
                full(obj.theRGCMosaic.rgcRFcenterConeConnectivityMatrix(indicesOfConesPooledByTheRFcenter,theTargetRGCindex)), ...
                [1 numel(indicesOfConesPooledByTheRFcenter)]);
            [~,~,theTargetVisualRFDoGparams.targetRGCdifferentMajorityConeType] = obj.centerConeTypeWeights(theTargetRGCindex);
            
            % Add relevant info to theTargetVisualRFDoGparams
            [~,~,theTargetVisualRFDoGparams.targetRGCmajorityConeType ] = obj.centerConeTypeWeights(obj.targetRGCindex(iMultifocalRTVFobjIndex));
            theTargetVisualRFDoGparams.indicesOfConesPooledByTheRFcenterOfDifferentMajorityConeType =  indicesOfConesPooledByTheRFcenter;
            theTargetVisualRFDoGparams.weightsOfConesPooledByTheRFcenterOfDifferentMajorityConeType =  weightsOfConesPooledByTheRFcenter;
        
            fprintf(2,'\n---> RTVF #%d: target RGC indices for L- and M-cone compute struct are: %d (%d) and %d (%d)\n\n', ...
                iMultifocalRTVFobjIndex, ...
                obj.targetRGCindex(iMultifocalRTVFobjIndex), ...
                theTargetVisualRFDoGparams.targetRGCmajorityConeType, ...
                obj.targetRGCindexOfDifferentMajorityConeType(iMultifocalRTVFobjIndex), ...
                theTargetVisualRFDoGparams.targetRGCdifferentMajorityConeType);
        ...
        progressFigureName = sprintf('RTVF obj %d located at position (degs): %2.2f, %2.2f with %d center cones', ...
                         iMultifocalRTVFobjIndex, ...
                         opticalPositionDegs(1), ...
                         opticalPositionDegs(2), ...
                         conesNumPooled);
        ...
        theRTVFobj = RTVF(...
                ...
                obj.stfComputeMethod, ...
                'multiStartsNumRetinalPooling', multiStartsNumRetinalPooling, ...
                'useParallelMultiStart', obj.useParallelMultiStart, ...
                ...
                'computeMethodResources', obj.stfComputeMethodResources, ...
                'fixedZernikeCoefficientsPositionDegs', obj.fixedZernikeCoefficientsPositionDegs , ...
                'visualizeSpectrallyWeightedPSFs', ~true, ...
                'computedRTVFobjectExportDirectory', exportsDirectory, ...
                'progressFigureName', progressFigureName);


        obj.RTVFTobjList{iMultifocalRTVFobjIndex} = theRTVFobj;
        ...
        if (theRTVFobj.RTVFfileWasUpdated)
