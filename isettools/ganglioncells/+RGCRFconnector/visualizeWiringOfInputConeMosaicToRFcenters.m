...
%
    ...
    coneColors = [theInputConeMosaic.lConeColor; ...
                  theInputConeMosaic.mConeColor; ...
                  theInputConeMosaic.sConeColor];
    ...
    if (isempty(XLims))
        XLims = [min(theInputConeMosaic.coneRFpositionsMicrons(:,1))-dd max(theInputConeMosaic.coneRFpositionsMicrons(:,1))+dd];
    end
    if (isempty(YLims))
        YLims = [min(theInputConeMosaic.coneRFpositionsMicrons(:,2))-dd max(theInputConeMosaic.coneRFpositionsMicrons(:,2))+dd];
    end
