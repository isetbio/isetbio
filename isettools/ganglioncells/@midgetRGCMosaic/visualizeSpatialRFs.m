function [hFig, allAxes] = visualizeSpatialRFs(obj, varargin)
    ...
    for iSortedRGCindex = 1:numel(sortedRGCindices)
        ...
        theRetinalRFcenterConeMap = midgetRGCMosaic.retinalSubregionConeMapFromPooledConeInputs(...
            obj.inputConeMosaic,...
        ...
        theConePositionsDegs = bsxfun(@minus, theConePositionsDegs, rfCenterPositionDegs);
        theRetinalRFsurroundConeMap = midgetRGCMosaic.retinalSubregionConeMapFromPooledConeInputs(...
            obj.inputConeMosaic,...
            theConePositionsDegs, ...
