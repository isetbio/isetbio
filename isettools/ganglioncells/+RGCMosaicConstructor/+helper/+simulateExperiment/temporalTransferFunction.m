...
function computeMRGCmosaicTTF(...
    ...
    if (photocurrentBasedTTFsComputed)
        ...
        passedRGCindex = computePhotocurrentResponsesOnlyForInputsToSingleRGCwithIndex;
        ...
        assert(passedRGCindex == computePhotocurrentResponsesOnlyForInputsToSingleRGCwithIndex, 'different RGC index');
        clear 'passedRGCindex'
