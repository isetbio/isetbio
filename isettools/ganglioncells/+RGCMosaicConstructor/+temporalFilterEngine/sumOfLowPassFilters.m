%
% RGCMosaicConstructor.temporalFilterEngine.sumOfLowPassFilters
%
%

function [theFilterTTF, initialValues, lowerBounds, upperBounds, paramNames, theCurrentParams] = ...
    sumOfLowPassFilters(theCurrentParams, temporalFrequencySupportHz)
    ...
    % delaySeconds
    initialValues(numel(initialValues)+1) = 44;
    ...
    initialValues(numel(initialValues)+1) = 3.5;
    ...
    upperBounds(numel(upperBounds)+1) = 35;
    ...
    upperBounds(numel(upperBounds)+1) = 0;
    paramNames{numel(paramNames)+1} = 'summation gain';
    ...
    % Differntiation gain
    summationGain = theCurrentParams(9);
    ...
    theFilterTTF = gain * theDelayFilterTTF .* (theLowPassFilterTTF +summationGain * theLowPassFilter2TTF);
