...
function spectrumPhasePlot(ax, temporalFrequencySupportHz, theTTF, theMarker, noXLabel, noYLabel, theColor, theLabel)

    plot(ax, temporalFrequencySupportHz, unwrap(angle(theTTF))/pi*180, theMarker, ...
