...
function theInnerRetinaTTF = innerRetinaFilterBetweenPhotocurrentBasedAndTargetTTF(...
    ...
    generateMagnitudePhaseSpectraPlots(temporalFrequencySupportHz, theTargetTTF, thePhotocurrentsBasedTTF, theDesiredInnerRetinaTTF);
    ...
    function theResidual = theObjectiveFunctionToMinimize(theCurrentParams, ...
        ...
        if (showFitResults) && (theResidual == min(residualsSequence(:)))
            ...
            RGCMosaicConstructor.temporalFilterEngine.spectrumMagnitudePlot(...
                ax, temporalFrequencySupportHz, theDesiredInnerRetinaTTF, ...
                true, false, [0 0 0], ...
                '');
            hold(ax, 'on');
            RGCMosaicConstructor.temporalFilterEngine.spectrumMagnitudePlot(...
...
function generateMagnitudePhaseSpectraPlots(temporalFrequencySupportHz, theTargetTTF, thePhotocurrentsBasedTTF, theDesiredInnerRetinaTTF)
    hFig = figure(999);
    set(hFig, 'Position', [10 10 1500 800]);
    ax = subplot(2,3,1);
    RGCMosaicConstructor.temporalFilterEngine.spectrumMagnitudePlot(...
        ax, temporalFrequencySupportHz, theTargetTTF, ...
        true, false, [0 0 0], ...
        'target (macaque) TTF');
    ...
    ax = subplot(2,3,2);
    RGCMosaicConstructor.temporalFilterEngine.spectrumMagnitudePlot(...
        ax, temporalFrequencySupportHz, thePhotocurrentsBasedTTF, ...
        true, true, [0 0 1], ...
