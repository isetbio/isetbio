function test_RetinaRFestimationFromTargetVisualRF
    ...
    if (regenerateData)
        ...
        [retinalRFparamsDictionary, opticsParams, targetVisualRFDoGparams, theCircularPSFData] = ...
...
function [retinalRFparamsDictionary, opticsParams, targetVisualRFDoGparams, theCircularPSFData] = ...
    computeRetinalRFparamsAcrossEccentricities(opticsParams, targetVisualRFDoGparams, retinalConePoolingModel)
    ...
    for iEcc = 1:numel(horizontalEccDegs)
        ...
        fprintf('Spatial support for ecc: %2.1f, %2.1f: %f degs\n', eccDegs(1), eccDegs(2), maxSpatialSupportDegs)
        ...
        % Save to dictionary
        eccLabel = sprintf('Ecc_%2.0f_%2.0f', eccDegs(1), eccDegs(2));
