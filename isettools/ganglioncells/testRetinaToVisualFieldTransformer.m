function testRetinaToVisualFieldTransformer(reComputeData)
   ...
   % comparison = 'acrossRFspatialCharacteristics & surround cone pooling models';
    ...
    switch (comparison)
        ...
        case 'acrossNumberOfConesInRFcenter'
            ...
            conesNumPooledByTheRFcenterList = [1]; %[1 2 3 4 5 6 7];
...
function batchJob(reComputeData, examinedSubjectRankOrder, horizontalEccDegs, ...
    ...
    opticsParams = struct(...
        'positionDegs', [horizontalEccDegs 0.0], ...  % (x,y) eccentricity for the PSF, in degrees
    ...
    if (reComputeData)
        ...
        theConeMosaic = cMosaic(...
            ...
            'eccentricityDegs', opticsParams.positionDegs, ...
            'sizeDegs', [1 1], ...
