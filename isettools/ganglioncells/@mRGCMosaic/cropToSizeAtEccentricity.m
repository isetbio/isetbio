function obj = cropToSizeAtEccentricity(obj, sizeDegs, eccentricityDegs, varargin)
    ...
    if (visualizeSpatialRelationshipToSourceMosaic)
        ...
        theROI.visualize(...
            ...
            'fillAlpha', 0.3, ...
            'edgeColor', [1 0 0]);
        set(ax, 'XLim', obj.eccentricityDegs(1) + 0.5*obj.inputConeMosaic.sizeDegs(1)*[-1 1], ...
                'YLim', obj.eccentricityDegs(2) + 0.5*obj.inputConeMosaic.sizeDegs(2)*[-1 1], ...
        ...
        title(ax, 'loaded mRGCmosaic and cropped region');
        drawnow;
    end
