...
function executePipelineAction(btn, app)
    ...
    switch app.currentPipeline
        ...
        case "CHECK: compare RTVFmodel STF to the computed STF of the source RGC"
            midgetRGCMosaicInspector.compareRTVFmodelSTFtoMeasuredSTF(...
                app.simulation.mosaicCenterParams, ...
                app.simulation.rfModelParams, ...
                app.simulation.opticsParams);
        ...
        case "VISUALIZATION (fited multifocal RTVF): fitted locations"
            midgetRGCMosaicInspector.visualizeFittedMultiFocalRTVF(...
                app.simulation.mosaicCenterParams, ...
                app.simulation.rfModelParams, ...
                app.simulation.opticsParams, ...
                'visualizedComponents', 'fitted locations');
            
        case "VISUALIZATION (fited multifocal RTVF): L- and M-cone weighted PSFs"
            midgetRGCMosaicInspector.visualizeFittedMultiFocalRTVF(...
                app.simulation.mosaicCenterParams, ...
                app.simulation.rfModelParams, ...
                app.simulation.opticsParams, ...
                'visualizedComponents', 'cone quantal efficiencies and psfs');

        case "VISUALIZATION (fited multifocal RTVF): retinal RFs with PSFs"
            midgetRGCMosaicInspector.visualizeFittedMultiFocalRTVF(...
                app.simulation.mosaicCenterParams, ...
                app.simulation.rfModelParams, ...
                app.simulation.opticsParams, ...
                'visualizedComponents', 'retinal RFs and psfs');

        case "VISUALIZATION (fited multifocal RTVF): STFs with PSFs"
            midgetRGCMosaicInspector.visualizeFittedMultiFocalRTVF(...
                app.simulation.mosaicCenterParams, ...
                app.simulation.rfModelParams, ...
                app.simulation.opticsParams, ...
                'visualizedComponents', 'stfs and psfs');
...
function generateGUI(obj)
    ...
    thePipelineDropdown.Items = [ ...
        ...
        "CHECK: compare RTVFmodel STF to the computed STF of the source RGC", ...
        "VISUALIZATION (fited multifocal RTVF): fitted locations", ...
        "VISUALIZATION (fited multifocal RTVF): L- and M-cone weighted PSFs", ...
        "VISUALIZATION (fited multifocal RTVF): retinal RFs with PSFs", ...
        "VISUALIZATION (fited multifocal RTVF): STFs with PSFs", ...
