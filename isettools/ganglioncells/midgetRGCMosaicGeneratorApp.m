...
function executeButtonAction(btn, app)
    ...
    switch app.currentAction
        ...
        case "generateCenterSurroundConePoolingKernels"
            midgetRGCMosaicGenerator.generateCenterSurroundConePoolingKernels(...
                app.simulation.mosaicCenterParams, ...
                app.simulation.mosaicSurroundParams);

        case "computeMosaicLMnonOpponentSTFs"
...
function generateGUI(obj)
    ...
    theActionDropdown.Items = [...
        "generate center-connected mRGC mosaic", ...
        "generate all R2VFT objects", ...
        "update specific R2VFT objects", ...
        "inspect single R2VFT object file", ...
        "inspect all R2VFT object files", ...
        "generateCenterSurroundConePoolingKernels", ...
        "computeMosaicLMnonOpponentSTFs", ...
        "fitMosaicSTFs", ...
        "visualizeSpatialRFs" ...
        ];
    ...
    % Current action
    obj.currentAction = "inspect all R2VFT object files";
