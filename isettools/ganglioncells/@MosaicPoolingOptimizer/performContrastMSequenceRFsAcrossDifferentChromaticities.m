function performContrastMSequenceRFsAcrossDifferentChromaticities(...
    ...
    theLconeIsolatingMSequenceResponsesFileName = strrep(theAchromaticMSequenceResponsesFileName, 'mRGCMosaicMSequence', 'LconeIsolatingmRGCMosaicMSequence');
    theMconeIsolatingMSequenceResponsesFileName = strrep(theAchromaticMSequenceResponsesFileName, 'mRGCMosaicMSequence', 'MconeIsolatingmRGCMosaicMSequence');
    ...
    MosaicPoolingOptimizer.contrastMSequenceRFsAcrossDifferentChromaticities(...
        ...
        rfPixelsAcross, opticsParamsForMSeqRFmapping, rawFiguresRoot, scaledFiguresRoot, exportScaledFigureVersionForManuscript,  ...
