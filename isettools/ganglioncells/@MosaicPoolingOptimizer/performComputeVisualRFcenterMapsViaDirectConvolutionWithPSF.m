...
function runAtEccentricity(axRetinal, axVisual, axPSF, ff, eccDegs)
    ...
    % Generate the psfData
    thePSFData = generateThePSFData(theMidgetRGCMosaic, opticsParams);
...
function thePSFData = generateThePSFData(theMidgetRGCMosaic, opticsParams)
