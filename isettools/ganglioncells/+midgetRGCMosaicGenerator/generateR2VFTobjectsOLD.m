function generateR2VFTobjectsOLD(mosaicCenterParams, rfModelParams, opticsParams, varargin)
    ...
    if (isempty(updateRTVFobjectAtPosition))
        ...
        [theRTFVTobjList, theOpticsPositionGrid, ...
         ...
         theVisualSTFSurroundToCenterIntegratedSensitivityRatioGrid] = midgetRGCMosaic.R2VFTobjectsOLD(...
