...
sfSupportForSTFresponses = logspace(log10(0.05), log10(50), 15);
meanLuminanceCdM2ForSTFresponses = 31.34;                 % Matching Lee&Shapley 2012
backgroundXYchromaticityForSTFresponses = [0.436, 0.476]; % Matching Lee&Shapley 2012
    ...
    switch (opticsForSTFresponses) 
        case  'refractionResidualWithRespectToNativeOptics'
            RGCMosaicAnalyzer.compute.inputConeMosaicSTFsForStimulusChromaticityAndOptics(...
                ...
                meanLuminanceCdM2ForSTFresponses, ...
                backgroundXYchromaticityForSTFresponses, ...
                chromaticityForSTFresponses, ...
                coneFundamentalsOptimizedForStimPosition, ...
