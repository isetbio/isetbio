...
if (generateConeRFpositionsLattice) || (generateMRGCRFpositionsLattice)
    ...
    if (1==2)
    retinalattice.generatePatch(...
        latticeParamsStruct.fovDegs, ...
        latticeParamsStruct.neuronType, ...
        latticeParamsStruct.whichEye, ...
        latticeParamsStruct.exportHistoryToFile, ...
        latticeParamsStruct.visualizeConvergence, ...
        latticeParamsStruct.useParfor, ...
        latticeParamsStruct.maxIterations, ...
        'eccentricityLookUpTableSamplesNum', latticeParamsStruct.eccentricityLookUpTableSize);
    end
