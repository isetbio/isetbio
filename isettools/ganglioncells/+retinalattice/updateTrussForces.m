function [netForceVectors, desiredSpringLengths] = updateTrussForces(rfPositions, tabulatedEcc, tabulatedRFspacing, springs, springIndices, desiredSpringLengths, rfSpacingFunctionFast, reTriangulationIsNeeded)
