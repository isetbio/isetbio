function [terminateNow, histogramData, widths, diffWidths, bin1Percent] = ...
    checkForEarlyTerminationDueToHexLatticeQualityDecrease(currentRFPositions, triangleIndices, widths, minHexQualityForTermination)
    
    qDist = retinalattice.computeMeshQuality(currentRFPositions, triangleIndices);
    qBins = [0.5:0.01:1.0];
