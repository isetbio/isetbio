...
if (coneExcitationsTransformedIntoResponseModulations)
    coneExcitationRateRange = 0.61*[-1 1];
    coneExcitationRateTicks = -1:0.2:1;
...
% The cone excitations response (1 or 2 periods)
...
% The photocurrent response (1 or 2 periods)
...
if (~isempty(photocurrentResponseTimeAxisPeriodic))
    ...
    plotResponseTimeCourse(axConeExcitationsPeriodic, ...
        ...
        [temporalSupportSecondsPeriodic(1) temporalSupportSecondsPeriodic(end)]*1e3, ...
        timeTicks, ...
        coneExcitationRateRange, ...
        coneExcitationRateTicks, ...
        coneExcitationRateTickLabels,...
...
function plotResponseTimeCourse(ax, isStairsPlot, temporalSupport, theResponse, theSecondResponse, theColor, theBaselineResponse, theYaxisLabel, thePlotTitle, xLims, xTicks, yLims, yTicks, yTickLabels, xtickangleForPlot)
...
xlabel(ax,'time (msec)');
xtickangle(ax,xtickangleForPlot);
