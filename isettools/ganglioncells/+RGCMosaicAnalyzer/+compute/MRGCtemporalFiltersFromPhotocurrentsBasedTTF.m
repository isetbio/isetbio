...
function MRGCtemporalFiltersFromPhotocurrentsBasedTTF(...
    ...
    switch (innerRetinaFilterDerivationParams.temporalFilterSynthesisMethod)
        ...
        case {'differenceOfLowPassFilters', 'differenceOfLowPassFilters2', 'sumOfLowPassFilters', 'dampedOscillationFilter', 'delayLeadLagFilter', 'delayLeadLagFilter2', 'delayHighPassFilter', 'asymmetricBandPassFilter'}
            ...
            frequencyWeights(bin1:bin2) = (1-((0:(bin2-bin1))*(1/(bin2-bin1)))).^0.5;
            ...
            [theInnerRetinaTTF, modelParams] = RGCMosaicConstructor.temporalFilterEngine.deriveInnerRetinaFilterBetweenPhotocurrentBasedAndTargetTTF(...
                ...
                innerRetinaFilterDerivationParams.componentFitted, ...
