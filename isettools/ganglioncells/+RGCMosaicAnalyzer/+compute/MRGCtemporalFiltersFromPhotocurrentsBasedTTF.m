...
function MRGCtemporalFiltersFromPhotocurrentsBasedTTF(...
    ...
    switch (innerRetinaFilterDerivationParams.temporalFilterSynthesisMethod)
        ...
        case 'differenceOfLowPassFilters'
            ...
            frequencyWeights(temporalFrequenciesExamined >= innerRetinaFilterDerivationParams.minFrequencyHzWithUnitWeight) = ...
                frequencyWeights(temporalFrequenciesExamined == innerRetinaFilterDerivationParams.minFrequencyHzWithUnitWeight);
    ...
    innerRetinaFilterDataStruct = struct(...
        ...
        'fittedInnerRetinalFilterType', fittedInnerRetinalFilterType, ...
    ...
    set(hFig, 'Position', [10 10 1000 1000], 'Name', sprintf('%s - %s', targetCellImpulseResponseSource, stimulusShape))
    ax = subplot('Position', [0.05 0.05 0.4 0.9]);
    ...
    ax = subplot('Position', [0.55 0.05 0.4 0.9]);
