...
function mosaicTTFsForStimulusChromaticityAndOptics(...
    ...
    p.addParameter('inputConeMosaicSizeFraction', 1.1, @isscalar);
    ...
    inputConeMosaicSizeFraction = p.Results.inputConeMosaicSizeFraction;
    ...
    TTFparamsStruct = struct(...
        ...
        'sizeDegs', inputConeMosaicSizeFraction*max(theMRGCMosaic.inputConeMosaic.sizeDegs), ...
