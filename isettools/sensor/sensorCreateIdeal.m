...
%
% Create an ideal image sensor array. The array
% contains ideal  pixels (no read noise, dark voltage, 100% fill-factor).
% Such an array can be used as a comparison to a typical sensor.  We also
% use this to simply calculate the number of photons incident at each
% pixel.
%
