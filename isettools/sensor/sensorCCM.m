...
%   Normally, this information is obtained by a user selection, and the
%   spatial information is returned in pointLoc.  If you already know the
%   pointLoc values, you can send them in and skip that interactive part.
%
