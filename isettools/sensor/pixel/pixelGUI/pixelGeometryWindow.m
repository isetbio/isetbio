...
% Last Modified by GUIDE v2.5 16-Aug-2003 08:04:39
...
isa.pixel.height = str2double(get(hObject,'String'))*(10^(-6));
if get(handles.btnMethod,'Value')
    fillfactor = str2num(get(handles.edit1FillFactor,'String'))/100;
...
[val,isa] = vcGetSelectedObject('ISA');
isa.pixel.width = str2double(get(hObject,'String'))*(10^(-6));
if get(handles.btnMethod,'Value')
    fillfactor = str2num(get(handles.edit1FillFactor,'String'))/100;
    isa = pixelCenterFillPD(isa,fillfactor);
end
...
[val,isa] = vcGetSelectedObject('ISA');
isa.pixel.widthGap = str2double(get(hObject,'String'))*(10^(-6));
if get(handles.btnMethod,'Value')
    fillfactor = str2num(get(handles.edit1FillFactor,'String'))/100;
    isa = pixelCenterFillPD(isa,fillfactor);
end
...
[val,isa] = vcGetSelectedObject('ISA');
isa.pixel.heightGap = str2double(get(hObject,'String'))*(10^(-6));
if get(handles.btnMethod,'Value')
    fillfactor = str2num(get(handles.edit1FillFactor,'String'))/100;
    isa = pixelCenterFillPD(isa,fillfactor);
end
...
[val,isa] = vcGetSelectedObject('ISA');
isa.pixel.pdHeight = str2double(get(hObject,'String'))*(10^(-6));
vcReplaceObject(isa,val);
pixelGeomRefresh(hObject,eventdata,handles);
...
[val,isa] = vcGetSelectedObject('ISA');
isa.pixel.pdWidth = str2double(get(hObject,'String'))*(10^(-6));
vcReplaceObject(isa,val);
...
[val,isa] = vcGetSelectedObject('ISA');
isa.pixel.pdXpos = str2double(get(hObject,'String'))*(10^(-6));
vcReplaceObject(isa,val);
pixelGeomRefresh(hObject,eventdata,handles);
...
% Pixel parameters
str = sprintf('%.1f',pixelGet(PIXEL,'height')*(10^(6))); set(handles.editHeight,'string',str);
str = sprintf('%.1f',pixelGet(PIXEL,'width')*(10^(6))); set(handles.editWidth,'string',str);
str = sprintf('%.2f',pixelGet(PIXEL,'widthGap')*(10^(6))); set(handles.editWidthGap,'string',str);
str = sprintf('%.2f',pixelGet(PIXEL,'heightGap')*(10^(6))); set(handles.editHeightGap,'string',str);

% Photodetector parameters
str = sprintf('%.2f',pixelGet(PIXEL,'pdHeight')*(10^(6))); set(handles.editPDHeight,'string',str);
str = sprintf('%.2f',pixelGet(PIXEL,'pdWidth')*(10^(6))); set(handles.editPDWidth,'string',str);
str = sprintf('%.2f',pixelGet(PIXEL,'pdXpos')*(10^(6))); set(handles.editPDXPos,'string',str);
str = sprintf('%.2f',pixelGet(PIXEL,'pdYpos')*(10^(6))); set(handles.editPDYpos,'string',str);
