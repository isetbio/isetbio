...
if notDefined('sampleSf'), sampleSf = 0:64;	    end    % Spatial frequency
if notDefined('Defocus'),   Defocus = -1:.05:1;	end    % Defocus range
if notDefined('wave'),      wave = 550;	        end    % Wavelength
...
D0 = 1/opticsGet(optics,'focallength');       % dioptric power of eye
