...
switch parm
    ...
    case {'model', 'opticsmodel'}
        ...
        %    Valid choices are listed below in variable valid.
        ...
        %
        % [Note: TL - I put back the ray trace model for now, since if we
        % switch to shiftinvariant it will try to find the lens info in the
        % oi.optics structure, which is non-existant for ray-tracing.
        % Because of this it will throw errors when you try to run
        % oiWindow. This requires more thought about how to handle this...]
