...
%    "On the depth  information in the point
%    spread function of a defocused optical system (Subbarao, 1999)"
%    The Subbarao paper claims there is an error in the formula, but I
%    don't think he is right.  He complains about the external scale
%    factor.  We do have a problem.  But I am not sure his solution is
%    right.
%
