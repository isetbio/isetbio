...
%
% Syntax:
%   oi = oiCombineDepths(oiD, scene, depthEdges)
%
% Description:
...
%    attached, but for now we send these in as the cell array depthEdges.
%
...
%
% Inputs:
%    oiD        - Cell Array. A cell array of OIs at different depths.
%    scene      - Struct. A scene structure.
%    depthEdges - Cell array. An array containing the depth of the planes.
%
% Outputs:
%    oi         - Struct. The combined defocused optical image structure.
%
