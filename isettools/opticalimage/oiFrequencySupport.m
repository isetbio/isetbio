...
%% Next, compute the spatial frequency list in cycles per degree
%
...
%
% But the oi field of view may differ from one, so we need to divide by the
% true number of degrees.
%
% For example:
