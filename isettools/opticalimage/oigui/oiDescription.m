...
%oiDescription:  Generate optical image text description for window
%
%   txt = oiDescription(oi,[handles])
%
% Writes the OI description for the box on the upper right of the window.
% Manages cases of diffraction-limited, shift-invariant, and ray trace
% separately.
%
