...
%
%  coneMosaic.current - The cone mosaic current is the photocurrent time
%  series
%
%  The bipolar response performs a spatio-temporal separable convolution
%  (first spatial filtering, then temporal filtering) of the cone current
%  to create the bipolar current.
%
...
%       bp.compute(cMosaic,'nTrialsInput',cMosaicCurrentMultipleTrials);
%
...
%
% Bipolar filters were created by deconvolving from the measured temporal
% impulse response of each cell in the mosaic and the linear cone temporal
% response. The mean of the bipolar temporal filters for the whole mosaic
% is used as the ideal bipolar filter.
%
...
for iTrial = 1:nTrials
    ...
    % Convolve spatial RFs across the conemosaic photocurrents
