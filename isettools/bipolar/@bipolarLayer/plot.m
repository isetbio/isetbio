...
% 
%    hdl = bipolarLayer.plot(parameter,nMosaic)
%
% For many parameters, this routine calls bipolarMosaic.plot. In that case
% the call is based on the integer nMosaic which specifies the mosaic for
% plotting.
%
...
%   bpL.plot('movie response','nMosaic',1);
%
