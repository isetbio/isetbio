...
%
%  Inputs:
%    d        - VARIES. Struct/String. This could be either a display
%               name or a display structure, see displayCreate for
%               further details.
%    I        - Matrix. Input image, should be a M * N * k matrix. k
%               should be equal to the number of primaries of display.
%    sz       - Numeric. The oversample size.
%
%  Output:
%    outImage - Matrix. upsampled image, the matrix of which should be
%               in Ms * Ns * k format. The default value for upscaling
%               factor s is equal to size(d.psfs, 1)
%
...
% History:
%    04/xx/14  HJ   Created April, 2014
