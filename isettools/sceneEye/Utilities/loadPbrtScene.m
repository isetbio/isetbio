...
%
% Outputs:
%    thisR       - Object. An ISET3D recipe object of selected scene after
...
if(sceneNameFlag)
    switch sceneName
        case('lettersAtDepth')
            ...
            thisR = piCreateLettersAtDepth('Adist', p.Results.Adist, ...
        ...
        case('lettersAtDepthPlus')
            % Move the letters in the scene. To do this, we're actually
            % going to remake the scene.
            thisR = piCreateLettersAtDepthPlus(...
        ...
        case('pointSource')
            ...
            thisR = piObjectTransform(thisR, 'Point', 'Scale', ...
                [p.Results.pointDiameter p.Results.pointDiameter 1]);
            thisR = piObjectTransform(thisR, 'Point', 'Translate', ...
                [0 0 p.Results.pointDistance]);
            % Make it large!
            thisR = piObjectTransform(thisR, 'Plane', 'Scale', ...
        ...
        case('texturedPlane')
            ...
            if(p.Results.useDisplaySPD)
                thisR = piWorldFindAndReplace(thisR, ...
