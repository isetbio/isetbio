...
%
% Inputs:
%    renderRecipe  - Un-modified renderRecipe
%    accommodation - Accommodation to shape the modified renderRecipe by
%    workingFolder - Location to write the new renderRecipe to
%
% Outputs:
%    renderRecipe  - The modified renderRecipe
%
...
iorNames = {sprintf('ior1_%0.2fdp_navarro.spd', accommodation), ...
    sprintf('ior2_%0.2fdp_navarro.spd', accommodation), ...
    sprintf('ior3_%0.2fdp_navarro.spd', accommodation), ...
    sprintf('ior4_%0.2fdp_navarro.spd', accommodation)};
