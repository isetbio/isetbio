...
lensA(1:2) = [anteriorRadius anteriorRadius]*-1; % flip because of sign conventions
lensP(1:2) = [posteriorRadius posteriorRadius]*-1; % flip because of sign conventions
...
str = sprintf('%.3f\n',focalLength);
fprintf(fid,'%s',str);
str = sprintf('# radiusX radiusY thickness materialIndex semiDiameter conicConstantX conicConstantY\n');
fprintf(fid,'%s',str);
