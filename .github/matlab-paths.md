...
the session you intend to use. 

If you need the MATLAB Desktop or Live Editor,
start the MATLAB Desktop first, then open VS Code and let the MATLAB extension start its separate background session as needed. 

See `.vscode/matlab-setup.md`
