            ...
            for vEccIndex = 1:size(zMap,1)
                for hEccIndex = 1:size(zMap,2)
                   ...
                   % ------ Subject 1 outliers ------ 
                    ...
                    % ------ Subject 4 outliers ------ 
                    inBadPointsSetOfSubject4= ...
                        (subjectIndex == 4) && ...
                        (PolansOptics.constants.measurementHorizontalEccentricities(hEccIndex) == 0) && ...
                        (ismember(PolansOptics.constants.measurementVerticalEccentricities(vEccIndex), [-1:-1:-20]));
                    ...
                    if ((~all(theCoeffs == 0)) && (~inBadPointsSetOfSubject1) && (~inBadPointsSetOfSubject2) && (~inBadPointsSetOfSubject3) && ...
                            (~inBadPointsSetOfSubject4) && (~inBadPointsSetOfSubject5) && (~inBadPointsSetOfSubject6) && (~inBadPointsSetOfSubject9) && ...
                            (~inBadPointsSetOfSubject10))
