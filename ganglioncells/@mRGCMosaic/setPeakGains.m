...
function setPeakGains(obj, method, methodParams)
    switch (method)
        case 'arbitrary'
            obj.responseGains = methodParams;
        ...
        case '1/integrated center cone weights'
            if (isfield(obj, 'rgcRFcenterConePoolingMatrix'))
                ...
                rgcRFcenterConePoolingMatrix = obj.rgcRFcenterConeConnectivityMatrix;
            end
            ...
            obj.responseGains = maxGain  * (centerConeWeightsSum .^ (-1.0));
        ...
        case '1/integrated center retinal cone apertures'
            ...
            maxGain = methodParams(1);
            obj.responseGains = maxGain * (integratedConeApertureAreas .^ (-1.0));
