function [theOptimalStrehlRatioOI, theOptimalStrehlRatioPSF, theOptimalStrehlRatioDefocusDiopters, theOptimalStrehlRatio, StrehlRatio] = ...
	...
	if (visualizeStrehlRatioOptimization) || (contrastOptimizedStrehlRatioPSFtoAsMeasuredAndCentralCorrection)
		...
		[~, psfEnsemble, zCoeffs] = theConeMosaic.oiEnsembleGenerate(...
        			oiPositionDegs, ...
			       'zernikeDataBase', zernikeDataBase, ...
	...
	if useParfor
		parfor iRefractiveError = 1:numel(examinedRefractionErrorDiopters)
			StrehlRatio(iRefractiveError) = localStrehlRatioForDefocus(...
				theConeMosaic, oiPositionDegs, zernikeDataBase, opticsParams, ...
				examinedRefractionErrorDiopters(iRefractiveError), wavefrontSpatialSamples, ...
...
function strehlRatio = localStrehlRatioForDefocus(theConeMosaic, oiPositionDegs, zernikeDataBase, ...
	opticsParams, defocusValue, wavefrontSpatialSamples, psfUpsampleFactor, ...
