function [theOptimalStrehlRatioOI, theOptimalStrehlRatioPSF, ...
    ...
    theOptimalStrehlRatio, StrehlRatio3DFunction] = ...
	optimized3DStrehlRatioPSF(examinedRefractionErrorDioptersObliqueAndVerticalAstigmatismErrorsMicronsGrid, ...
	...
	StrehlRatio3DFunction = zeros(1, size(examinedRefractionErrorDioptersObliqueAndVerticalAstigmatismErrorsMicronsGrid,1));
	...
	if (useParfor)
		parfor iRefractiveError = 1:size(examinedRefractionErrorDioptersObliqueAndVerticalAstigmatismErrorsMicronsGrid,1)
			...
			StrehlRatio3DFunction(iRefractiveError) = localStrehlRatioForDefocus(...
	...
	[theOptimalStrehlRatio, iRefractiveError] = max(StrehlRatio3DFunction(:));
	theOptimalStrehlRatioDefocusDiopters = examinedRefractionErrorDioptersObliqueAndVerticalAstigmatismErrorsMicronsGrid(iRefractiveError,1);
    theOptimalStrehlRatioObliqueAndVerticalAstigmatismMicrons = examinedRefractionErrorDioptersObliqueAndVerticalAstigmatismErrorsMicronsGrid(iRefractiveError,2:3);
    ...
    fprintf(2,'\nWill employ a defocus value of %2.3fD, and O/V astigmatic values of (%2.3f,%2.3f) microns for which the Strehl ratio is maximed (%2.3f)\n\n', ...
	...
	if (contrastOptimizedStrehlRatioPSFtoAsMeasuredAndCentralCorrection)
        ...
        StrehlRatio3Dmap = reshape(StrehlRatio3DFunction, [...
        ...
        [i1, i2, i3] = ind2sub(size(StrehlRatio3Dmap), iRefractiveError);
        ...
        hold(ax5, 'on');
        plot(ax5, theOptimalStrehlRatioDefocusDiopters, theOptimalStrehlRatioObliqueAndVerticalAstigmatismMicrons(1), 'bs', 'MarkerSize', 20);
