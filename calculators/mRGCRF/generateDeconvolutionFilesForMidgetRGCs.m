...
%{
   ...
   generateDeconvolutionFilesForMidgetRGCs('PolansSubjectID', 10, ...
    ...
    % Generate CENTER deconvolution data for subject 10 optics for ecc of 1 deg and for
     ...
     RF center (visualConeImage)

     customSensitivityRangeOverWhichToMatchSFtuning = [1.0 0.8];
     examinedConesNumInRFcenter = [1 2 3 4 5 6];
     eccTested = [4 8 12];
     generateDeconvolutionFilesForMidgetRGCs('PolansSubjectID', 10, ...
        'subregion', 'center', ...
        'eccTested', eccTested, ...
        'sensitivityRangeOverWhichToMatchSFtuning', customSensitivityRangeOverWhichToMatchSFtuning, ...
    ...
    eccTested =  [0 0.1 0.2 0.3 0.5 0.75 1 1.5 2 2.5 3 4:10];
    ...
    generateDeconvolutionFilesForMidgetRGCs('PolansSubjectID', 4, ...
        'subregion', 'surround', ...
        'eccTested', eccTested(eccTested>=4), ...
        'examinedConesNumInRFCenter', 1:6, ...
        'generateNewDeconvolutionFiles', true, ...
        'visualizeFits', ~true, 'exportFig', ~true, ...
        'visualizeDeconvolutionModel', false, ...
        'synthesizeDemoRFparams', false);
...
%    8/2020  NPC  ISETBIO TEAM, 2020
    ...
    p.addParameter('eccTested', [0 0.1 0.2 0.3 0.5 0.75 1 1.5 2 2.5 3 4:20] );
