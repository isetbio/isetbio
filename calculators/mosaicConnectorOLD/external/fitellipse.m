function [z, a, b, alpha, noFit] = fitellipse(x, varargin)
...
% Parse inputs
[x, params, noFit] = parseinputs(x, params, varargin{:});
...
switch params.constraint
    ...
    case 'bookstein'
        [z, a, b, alpha, noFit] = fitbookstein(x);
        
    % 'trace' constraint, lambda1 + lambda2 = trace(A) = 1
    case 'trace'
        [z, a, b, alpha, noFit] = fitggk(x);
end % switch
...
function [z, a, b, alpha, noFit] = fitbookstein(x)
...
% Find the parameters
[z, a, b, alpha, noFit] = conic2parametric(A, bv, c);

end % fitellipse


function [z, a, b, alpha, noFit] = fitggk(x)
...
function [z, a, b, alpha, noFit] = conic2parametric(A, bv, c)
...
function [x, params, noFit] = parseinputs(x, params, varargin)
