function MosaicConnector
    ...
    if (recomputePhase1)
        ...
        [connectivityMatrix, conePositionsMicrons, RGCRFPositionsMicrons, coneSpacingsMicrons] = computeConnectionMatrix(RGCRFPositionsMicrons, conePositionsMicrons, RGCRFSpacingsMicrons, desiredConesToRGCratios, roi, thresholdSeparationMicronsForRemovingUnitsFromMosaic);
