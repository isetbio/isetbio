...
%
% Syntax: [x]=PAL_SDT_AS_PCto2uneqSL(PC,r,g,p,M,Q);
% 
...
% Example:
%
% [x]=PAL_SDT_AS_PCto2uneqSL(0.75,1.5,[1 1],[2 2],2,2)
%
% returns:
% 
% x =
...
% of g, N=2 vector of p,  a scalars M=2, and scalar Q=2.  The output is 
% a N=2 vector of x
%
% Introduced: Palamedes version 1.8.0 (FK)

function [x]=PAL_SDT_AS_PCto2uneqSL(PC,r,g,p,M,Q)
...
func=@PAL_SDT_AS_2uneqSLtoPC;

x(1)=PAL_minimize(@PAL_sqDistanceYfuncX,0,options,PC,func,r,g,p,M,Q); % note: x guess param is set to 0
