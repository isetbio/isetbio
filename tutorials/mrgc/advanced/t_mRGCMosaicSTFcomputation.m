...
%{
    ...
    t_mRGCMosaicSTFcomputation(...
        ...
        'STFcontrast', 0.25, ...                             % Matching Lee&Shapley 25% and 27% L/M cone contrasts, 60 for achromatic)
        'computeInputConeMosaicResponses', true, ...
        'STFtemporalFrequencyHz', 2.5, ...
        'mRGCNonLinearityParamsStruct', ...
            struct('type', 'photocurrent'), ...
        'spatialPhaseIncrementDegs', 2, ...                  % When using pCurrent, we need high temporal sampling rate, so make the spatial phase increment low
