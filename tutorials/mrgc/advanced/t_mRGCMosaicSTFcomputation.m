...
arguments
    ...
    options.inspectInputConeMosaicResponses (1,1) logical = true;

    % Whether to compute the input cone mosaic STF responses
    options.computeMRGCMosaicResponses (1,1) logical = true;
...
theInputConeMosaicSTFResponsesFileName = fullfile('scratchspace', sprintf('LeeInputConeMosaicSTFresponses%s.mat', postFix));
...
theMRGCMosaicSTFResponsesFileName = fullfile('scratchspace', sprintf('LeeMRGCMosaicSTFresponses%s.mat', postFix));
