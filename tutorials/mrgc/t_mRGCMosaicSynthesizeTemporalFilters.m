...
%{
    ...
    % High-res run: 200 Hz, to get 5 msec resolution
    BenardeteKaplanScreenRefreshRateHz = 200;
    tfMinHz = 0.5;
    tfDeltaHz = 0.5;
    tfMaxHz = BenardeteKaplanScreenRefreshRateHz/2;
    examinedTemporalFrequencies = tfMinHz : tfDeltaHz : tfMaxHz;

    spotStimulusPositionDegs = [-6.091 -0.057];
    spotStimulusDiameterDegs = 0.03;
