...
%{
    ...
    temporalPhaseIncrementDegs = struct('val', 12, 'maxCorrespondingFrameDurationMsec', 5);


    % Stimulus position (centered on a single mRGC given the current PSF)
    stimulusPositionDegs = [-6.091 -0.057];
    ...
    annulusStimulusInnerOuterDiametersDegs = [0.035 0.4];
...
arguments
    ...
    options.temporalPhaseIncrementDegs (1,1) struct = struct('val', 12, 'maxCorrespondingFrameDurationMsec', []);
