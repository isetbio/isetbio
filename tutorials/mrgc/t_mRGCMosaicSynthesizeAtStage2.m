...
%
    ...
    t_mRGCMosaicSynthesizeAtStage2(...
        'rgcMosaicName', 'JCNpaperNasal7DegsMosaic', ...
        'opticsSubjectName', 'JCNpaperSecondSubject', ...
    ...
    % Generate a mosaic at 25 degs (temporal retinal, equivalent to 6.75mm, where the Field et al (2010) cone inputs to mRGCs were measured)
