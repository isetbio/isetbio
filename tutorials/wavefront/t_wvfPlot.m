...
% There is a bit of an art to setting the number
% of samples, because of reciprocal relation between
% sampling in pupil and retinal domains.  This choice
% is an OK compromise, but you can get finer results
% with additional fussing
...
%
% Notice that we don't get an Airy disk, because the
% calculation includes chromatic aberrations.  These
% show up in the optical phase plot in the pupil plane.
%
% Another way to say this is that the pupil function is
% specified at a measurement wavelength, and when we
% calculate at different wavelengths a model of defocus
% is applied according to a model of the human eye's 
