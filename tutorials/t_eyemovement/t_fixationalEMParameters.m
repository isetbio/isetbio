...
% Showcase the effects of changing various eye movement parameters.
%
% Description:
...
%
% Notes:
%    * [Note: XXX - The random seed doesn't seem to work between compute()
%      and computeForConeMosaic(). Look into it.]
%
...
em.computeForConeMosaic(cm, nEyeMovements, 'nTrials', nTrials, 'rSeed', 1);
