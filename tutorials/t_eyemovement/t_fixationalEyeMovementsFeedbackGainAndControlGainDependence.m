...
%    well within the range reported by Cherici et al.
%
...
for iVar = 1:numel(controlGammaGrid)
    ...
    plotEMpath(hFig1, subplotPosVectors, iVar, controlGammaGrid, ...
...
function plotEMpath(hFig, subplotPosVectors, iVar, controlGamma, ...
...
%
% Syntax:
%   plotEMpath(hFig, subplotPosVectors, iVar, controlGamma, ...
