...
%% 
% For the simpler, rectangular mosaic, see coneMosaic.
...
sizeDegs = [1 1];
cm = cMosaic(...
    'size degs', sizeDegs, ...         % SIZE: 1.0 degs (x) 0.5 degs (y)
...
cm.visualize('figureHandle', hFig, ...
    ...
    'vertical activation SliceEccentricity', -0.2, ...
    'vertical activation ColorBar', true, ...
