...
% This is the standard human lens model.  It is a good approximation
% over the central 10 deg (see Visual Encoding:  Principles and
% Software, in the Circadian Rhythms book, Figure 6).
oi = oiCreate;

%{
 % To get an OI specific for this visual field position, use
