...
%% Programming note
%
% I am not happy that the spatial sampling of the PSF is so arbitrary and
% poorly controlled.  We need to figure out when the frequency/spatial
% sampling gets set and do a better job of controlling it.
%
