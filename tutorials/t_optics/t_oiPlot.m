...
%
% Here the vector roiLocs gives x,y position.  Only
% the x position is used when plotting a vertical line
% through the image.
roiLocs = [20 20];
...
%
% This involves user interaction, because the roi is not
% passed explicltiy, so it is commented out.
% Sselect and execute.
%{
