...
%
% Description:
%    Demonstrates how to spatially low-pass a mosaic's responses.  You might want to
%    do this before subsampling, and you might want to subsample to speed up some
%    computation.
%
% See also: coneMosaic.lowPassMosaicResponse, coneMosaic.demosaicedResponses.

% NPC, ISETBIO Team, 2016
%
% 08/08/17  dhb   Remove current computations as they were broken and not being used.
%                 Commenting pass.
...
[isomerizationsMapLowPassed, Lmap, Mmap, Smap] = cMosaic.lowPassMosaicResponse(isomerizationsMap, lowPassSpaceConstantInMicrons);
