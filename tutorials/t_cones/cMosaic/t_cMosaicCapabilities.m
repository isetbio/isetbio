...
%    and their effect on the computed mean response. Properties examined
...
%% Demonstrate the effect of ecc-dependent macular pigment density
cond1Struct = struct(...
...
%% Demonstrate the effect of ecc-dependent macular pigment density during eye movements
cond1Struct = struct(...
...
function runItWithEyeMovements(oi, mosaicSize, mosaicEcc, cond1Struct, cond2Struct, figNo, plotTitle)
    ...
    for timePoint = 1:timeSeriesLength  
        visualizeResponses(cm, squeeze(r1(1,timePoint,:)), squeeze(r2(1,timePoint,:)), ...
...
function visualizeResponses(cm, r1, r2, emStruct, t1, t2, figNo, figName)
