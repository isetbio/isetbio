...
cm.visualize(...
    ...
    'axesHandle', ax, ...
    'domain', 'degrees', ...
    'plotTitle', 'cropped from 45x45 deg mesh (support: deg)');
...
cm.visualize(...
    ...
    'axesHandle', ax, ...
    'domain', 'microns', ...
    'plotTitle', 'cropped from 45x45 deg mesh (support: um)');

%%  Method 2. Generate a @cMosic object by generating its mesh. This can be slow, especially
