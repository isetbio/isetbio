function testResults = isetbioTutorialsTest(scriptName)
% isetbioTutorialsTest - Runs all s_* and t_* scripts in the tutorials directory safely
%
% Usage:
%   testResults = isetbioTutorialsTest;
%   testResults = isetbioTutorialsTest(scriptName);
%
...
targetDir = fullfile(isetbioRootPath, 'tutorials');
...
logInfo = ieInitTutorialExampleRunLog(repoRoot, 'isetbioTutorialsTest', targetDir, allFiles, scriptName);
...
testResults = localRunAllFiles(allFiles, targetDir, 'isetbioTutorialsTest', existingFigures, logInfo);
localPrintSummary('isetbioTutorialsTest', testResults);
