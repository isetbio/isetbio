% LBF functions for Gretag/Macbeth color checker functions
%
% Description:
...
%
%      (a) Read reflectances and create the basis functions
%      (b) Approximate the original functions with lower dimensions
%      (b) Render images of the approximation under a variety of lights
%
...
set(p, 'linewidth', 1);
t = xlabel('Wavelength (nm)');
set(t, 'fontname', 'Georgia')
t = ylabel('Reflectance');
set(t, 'fontname', 'Georgia')
grid on
