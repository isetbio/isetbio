...
%%t_simplePhotocurrentComputation  Illustrates how to compute photocurrent 
...
subplot(3,1,2)
plot(responseTimeAxis,meanLconeResponse ,'r-', 'LineWidth', 1.5); hold on;
plot(responseTimeAxis,meanLconeResponse+stdLconeResponse ,'r:', 'LineWidth', 1.0);
plot(responseTimeAxis,meanLconeResponse-stdLconeResponse ,'r:', 'LineWidth', 1.0);

plot(responseTimeAxis,meanMconeResponse,'g-', 'LineWidth', 1.5); hold on;
plot(responseTimeAxis,meanMconeResponse+stdMconeResponse ,'g:', 'LineWidth', 1.0);
plot(responseTimeAxis,meanMconeResponse-stdMconeResponse ,'g:', 'LineWidth', 1.0);

plot(responseTimeAxis,meanSconeResponse,'b-', 'LineWidth', 1.5); hold on;
plot(responseTimeAxis,meanSconeResponse+stdSconeResponse ,'b:', 'LineWidth', 1.0);
plot(responseTimeAxis,meanSconeResponse-stdSconeResponse ,'b:', 'LineWidth', 1.0);
...
subplot(3,1,3);
plot(responseTimeAxis,squeeze(mean(l_curr(maxLconeIndex,:, :),3)),'r', 'LineWidth', 1.5); hold on
plot(responseTimeAxis,squeeze(mean(m_curr(maxMconeIndex,:, :),3)),'g', 'LineWidth', 1.5);
plot(responseTimeAxis,squeeze(mean(s_curr(maxSconeIndex,:, :),3)),'b', 'LineWidth', 1.5);
