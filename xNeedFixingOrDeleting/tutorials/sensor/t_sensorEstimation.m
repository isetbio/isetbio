%% t_sensorEstimation
%
% Review of sensor estimation for spectral QE
% 
...
%% Introduction
% In this tutorial, we will introduce several color calculations that are
% relevant to camera and scanner calibration.  These calculations involve
% thinking about the sensors in the camer and scanner.  As you perform the
...
%% Creating a spectral power distribution of reflected light 
% This reflected light will be the signal encoded by
% the scanner.
...
% The light reflected from the surface is the pointwise product of the
...
% As examples, plot the spectral signal reflected from the green and
...
%% Predicting sensor respones to D65 reflected from Macbeth chart
%
...
% We can plot the rgb responses of this scanner to the light reflected from
...
%% For the reader
% Now, you should plot the estimate and the rgbPredictions to see how well
% we did.
