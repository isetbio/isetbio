...
%
%  1. A fairly common polynominal approach. 
%     See Shah et. al. 1994 for details
%  2. A hardware implementation friendly coefficient method. 
%     See Blasinski et al. ICME 2011 for details.
%
...
%% Compute with the wide angle lens
...
%% Compute the Corrected to distorted image height mapping.
...
legend('Mesured','2^{nd} order approx.');

%% 1. Remove the barrel distortion from the optical image
...
%% 2. Remove barel distortion using the coefficient method
