function results = opticalimageUnitTest(mode)
% OPTICALIMAGEUUNITTEST  Run unit tests for the opticalimage subsystem.
%
% Usage:
%   results = opticalimageUnitTest;          % core suite (default)
%   results = opticalimageUnitTest('full');  % includes FullOnly tests

if ieNotDefined('mode'), mode = 'core'; end
results = localRunTests(mode, 'opticalimageUnitTest');
