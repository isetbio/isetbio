...
try
    ...
    %% Get the isomerizations the PTB way
    %
    ...
    spdRadianceEnergy  = displayGet(d, 'spd primaries');
    ...
    spdIrradianceEnergy = RadianceAndPupilAreaEyeLengthToRetIrradiance(spdRadianceEnergy,WlsToS(wave),pupilAreaMeters2,eyeLengthMeters);
    spdIrradianceEnergy = spdIrradianceEnergy*(wave(2)-wave(1));
    spdIrradiancePhotons = EnergyToQuanta(SToWls(wave),spdIrradianceEnergy);
    ...
    spdMagCorrectIrradiancePhotons = spdIrradiancePhotons/(1+abs(m))^2;
    ...
    PTBcal = ptb.GeneratePsychToolboxCalStruct(...
        ...
        'wave', wave, ...
        'spd', spdMagCorrectIrradiancePhotons, ...
