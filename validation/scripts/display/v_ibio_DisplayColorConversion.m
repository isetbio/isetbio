...
%
% Multiply by the lens transmittance, to compare with old validations
S_cones   = WlsToS(cMosaic.wave);
T_conesQE = cMosaic.qe';

% We need to sample this at cMosaic.wave values.
lensTransmittance = oiGet(oi,'optics transmittance',cMosaic.wave);
