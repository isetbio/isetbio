...
oisHarmonic;
fov = oiGet(oiHarmonicSeq.oiFixed,'fov');
oiTime = oiHarmonicSeq.oiTimeAxis;
oiTime2 = oiTime/2;
oiHarmonicSeq.oiTimeAxis = oiTime2;
...
% Generate nTrials eye movement sequences
...
function [theConeMosaic, theOIsequence, ...
    ...
    [allInstancesAbsorptionsCountSequence, absorptionsTimeAxis, ...
        allInstancesPhotoCurrents, photoCurrentTimeAxis] = ...
