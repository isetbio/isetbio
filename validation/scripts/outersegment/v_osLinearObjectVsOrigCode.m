function varargout = v_osLinearObjectVsOrigCode(varargin)
%
...
% cone outer segments.
%
% More specifically, what this does is verify that the current outersegment object
...
% This makes every cone an L cone, despite the fact
% that the inline comment says s cone.
sensor = sensorSet(sensor,'cone type', 2); % set s cone
