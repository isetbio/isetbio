...
toleranceFraction = 1e-5;
UnitTest.validationData('arcmin0', arcmin0, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'arcmin0', toleranceFraction*abs(mean(arcmin0(:)))); 
UnitTest.validationData('arcmin3', arcmin3, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'arcmin3', toleranceFraction*abs(mean(arcmin3(:)))); 
UnitTest.validationData('arcmin4', arcmin4, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'arcmin4', toleranceFraction*abs(mean(arcmin4(:)))); 
UnitTest.validationData('psfLine0', psfLine0, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'psfLine0', toleranceFraction*abs(mean(psfLine0(:)))); 
UnitTest.validationData('psfLine3', psfLine3, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'psfLine3', toleranceFraction*abs(mean(psfLine3(:)))); 
UnitTest.validationData('psfLine4', psfLine4, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'psfLine4', toleranceFraction*abs(mean(psfLine4(:)))); 
UnitTest.validationData('onedPSF3', onedPSF3, ...
        'UsingTheFollowingVariableTolerancePairs', ...
        'onedPSF3', toleranceFraction*abs(mean(onedPSF3(:)))); 
