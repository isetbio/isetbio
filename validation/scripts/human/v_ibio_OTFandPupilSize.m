...
%
% Conclusion:
%   The Watson model does not account for chromatic aberration, so they can
%   not agree there.  
%   
%   Also, we have multiple ISETBio values for different subjects. For the
%   standard wavefront subject (based on Thibos) or for the Marimont and
%   Wandell model (not shown), at 560 nm and pupil diameter of 3-4mm, they
%   are close to one another.
%
%   The two calculations do not agree closely as a function of pupil
%   diameter - even at 560nm.
% 
...
plotOTFslices(h.Number, textLabel, legendEntries,otf_sfX, OTFslices);
end
...
plotOTFslices(h.Number, textLabel, legendEntries, modelOTFsfX, modelOTFslices);
