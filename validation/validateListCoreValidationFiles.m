...
vScriptsList = {...
        {fullfile(rootDir, 'scripts', 'color', 'v_Colorimetry'), []} ... 
        {fullfile(rootDir, 'scripts', 'human', 'v_HumanRetinalIlluminance580nm'), []} ... 
        {fullfile(rootDir, 'scripts', 'human', 'v_OTFandPupilSize'), []} ... 
    };
