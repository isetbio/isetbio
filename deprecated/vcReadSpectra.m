...
% OLD COMMENTS
%
%      [res,wave,comment,fName] = vcReadSpectra(fname,wave,extrapVal)
%
...
%    [data,wave] = vcReadSpectra(fullName)
%
...
%         warning('vcReadSpectra:File','Cannot find file %s. Returning empty data.',partialName);
%         return;
%     end
% end
% 
