...
%
% This script illustrates how to calculate defocus and depth of field using
% the Lensmaker's Equation and Hopkins w20 parameter.  This equation
% applies to thin lenses. We can calculate the defocus assuming the sensor
% is either at the focal length of the lens, or further away.
% 
% For further discussion about the Lensmaker's Equation see
% opticsDepthDefocus.m.
%
% For discussion about Hopkins w20 measure used in the depth of field
...
%% The image distance as we vary the object distance

% Now we use the opticsDepthDefocus to calculate the image distance for
...
%%  It is also useful to plot this with respect to focal lengths
vcNewGraphWin;
