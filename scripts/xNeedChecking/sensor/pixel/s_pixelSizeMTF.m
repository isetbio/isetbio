%% s_pixelSizeMTF
% 
%   Illustrate how pixel size influences the modulation transfer function
%
%  This script also illustrates how to
%
%       (a) define a scene
%       (b) create an optical image from the scene
%       (c) define a sensor
%       (d) evaluate the sensor MTF over a range of possible sensor
...
%  suggest that you begin programming scripts using other, simpler
%  routines.  We include this script because it shows many features of the
%  scripting language and the ability to interact with the GUI from
%  scripts.
%
...
%% OPTICS: Create an optical image with some default optics.
oi = oiCreate;
...
%%  SENSOR: Create a default monochrome image sensor array
...
%% Run the main computational loop
