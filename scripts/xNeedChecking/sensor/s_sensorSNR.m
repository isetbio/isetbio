% s_sensorSNR
%
% This script illustrates how pixel and sensor parameters influence sensor
% SNR. It also illustrates how to perform these calculations and graph the
% results.
%
...
% and DSNU.
f = vcNewGraphWin;
semilogx(volts,SNRprnu,'r-',volts,SNRdsnu,'b-');
grid on; ylabel('SNR (db)'); xlabel('Volts')
legend('PRNU','DSNU')
