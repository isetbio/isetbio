function hFig = coVisualizeRetinalStimulusConeAndMRGCmosaic(figNo, theMRGCMosaic, theStimulusRetinalImage)
    ...
    ax = subplot('Position', [0.05 0.05 0.94 0.92]);
    ...
    theMRGCMosaic.inputConeMosaic.visualize(...
        ...
        'withsuperimposedOpticalImageAlpha', 0.4, ...
        'domainVisualizationLimits', domainVisualizationLimits, ...
        'domainVisualizationTicks', struct('x', -30:30, 'y', -30:30), ...
        'plotTitle', 'retinal image + cone mosaic + mRGC mosaic');
end